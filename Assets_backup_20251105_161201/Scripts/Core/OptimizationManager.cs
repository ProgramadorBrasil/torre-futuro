...
namespace SpaceRPG.Core
{
    ...
    public class OptimizationManager : MonoBehaviour
    {
        ...
        private void InitializeNativeArrays()
        {
            // Burst/Jobs not available - using fallback
            Debug.LogWarning("Burst Compiler e Jobs System não estão instalados. Performance não otimizada.");
        }
#endif
